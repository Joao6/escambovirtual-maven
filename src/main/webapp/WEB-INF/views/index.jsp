...
<html>
    ...
    <body class="bodyFont">
        ...
        <div class="row titulo1">
            <div class="container">
                <h3 class="titulo">Conheça mais sobre o <br/>Escambo Virtual</h3>
                <hr id="linha">
            </div>
        </div>
        <div class="sobre">
                ...
                <div class="center-align">                    
                    <div class="row">
                        <div class="col s12 l4 m4 box1">
                            <img class="img responsive-img circle" src="<c:url value="/resources/img/sign-check-icon.png"/>">
            ...
            <div class="container" style="margin-top: -4%;">
                <div class="row">
                    <div class="box4 col s12 m2 l2">
                        <img class="img responsive-img circle" src="<c:url value="/resources/img/joao.jpg"/>">
                    </div>
                    <div class="box5 col s12 m2 l2">
                        <h5 class="nomes">Joao Pedro</h5>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam faucibus fermentum pharetra.</p>
                    </div>
                    <div class="box6 col s12 m2 l2">
                        <img class="img responsive-img circle" src="<c:url value="/resources/img/mauricio.jpg"/>">
                    </div>
                    ...
                    <div class="box8 col s12 m2 l2">
                        <img class="img responsive-img circle" src="<c:url value="/resources/img/pedro.jpg"/>">
                    </div>
        ...
        <!-- RODAPÉ -->
        <footer class="page-footer blue darken-2" style="margin-top: -5%;">
            <div class="container">
                <div class="row">
